...
/*Adds the state from which the method was called and puts the new state atop of the state stack.
That results in the preservation of state from which this method was called.*/
